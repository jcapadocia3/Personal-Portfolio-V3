    ...
    <div class="mainCont">
      <section class="aboutMe" id="aboutMe">
        ...
        <p>
          ...
          certificate in Coding and Full Stack Web/App Development. This type of
          work has always intrigued me, and after 32 years in this world, I was
          able to convince myself that, "It's never too late for school, nor to
          ...
          CSS - Javascript - Client-side and server-side APIs With still so much
          time left in the program, I am excited to continue to master these
          skills, as well as learn new skills, to allow for further creativity
          in my craft.
        </p>
      </section>
    </div>
